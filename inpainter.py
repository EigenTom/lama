...
class Inpainter:
    ...
    def _load_model(self):
        ...
        model = load_checkpoint(self.train_config, checkpoint_path, strict=False, map_location=self.device)
        model.freeze()
        if not self.refine:
...
if __name__ == "__main__":
    ...
    model_path = "/home/axton/axton-workspace/csc2125/model_weights/lama_weights/big-lama"
    checkpoint_name = "best.ckpt"
    indir = "/home/axton/axton-workspace/csc2125/models/lama/imgs/test4"
    # indir = "/home/axton/axton-workspace/csc2125/out/step2_inpainting/tmp_input"
    ...
    # read in all images in the indir and resize them to 512x512
